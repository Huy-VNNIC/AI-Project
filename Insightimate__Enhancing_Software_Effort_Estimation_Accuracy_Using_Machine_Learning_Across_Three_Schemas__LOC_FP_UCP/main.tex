...
Eqs.~\ref{eq:cocomo-effort}--\ref{eq:cocomo-time} often underfit heterogeneous,
...
\begin{table*}[t]
\centering
\caption{Dataset Provenance Manifest -- Full auditability with source, year, DOI/URL, raw counts, deduplication, train-test splits, and reproducibility information per schema.}
\label{tab:dataset-manifest}
\tiny
\begin{tabular}{@{}l c l c r r r r l l@{}}
\toprule
\textbf{Source} & \textbf{Year} & \textbf{DOI / URL} & \textbf{Schema} & \textbf{Raw} & \textbf{Dedup} & \textbf{Train} & \textbf{Test} & \textbf{License} & \textbf{Access} \\
\midrule
\multicolumn{10}{l}{\textit{LOC-based datasets}} \\
\quad DASE (Rodríguez et al.)\textsuperscript{\dag} & 2023 & \texttt{github.com/danrodgar/DASE} & LOC & 1,203 & 1,050 & 840 & 210 & CC0 & Public \\
\quad Freeman et al. & 2022 & \texttt{github.com/Freeman-md/software-project-development-estimator} & LOC & 487 & 450 & 360 & 90 & MIT & Public \\
\quad Derek Jones\textsuperscript{*} & 2022 & \texttt{github.com/Derek-Jones/Software-estimation-datasets} & LOC & 328 & 312 & 250 & 62 & CC0 & Public \\
\quad NASA MDP (nasa93) & 1993 & PROMISE repository & LOC & 93 & 93 & 74 & 19 & Open & Public \\
\quad Telecom1 & 2001 & \texttt{doi.org/10.1109/...} & LOC & 18 & 18 & 14 & 4 & Research & Public \\
\quad Maxwell & 2002 & PROMISE repository & LOC & 62 & 62 & 50 & 12 & Open & Public \\
\quad Miyazaki & 1994 & PROMISE repository & LOC & 48 & 48 & 38 & 10 & Open & Public \\
\quad Chinese (China) & 2007 & PROMISE repository & LOC & 499 & 486 & 389 & 97 & Open & Public \\
\quad Finnish & 1990 & PROMISE repository & LOC & 38 & 38 & 30 & 8 & Open & Public \\
\quad Kitchenham & 2002 & PROMISE repository & LOC & 145 & 145 & 116 & 29 & Open & Public \\
\quad COCOMO81 & 1981 & \texttt{doi.org/10.1109/TSE.1984.5010193} & LOC & 63 & 63 & 50 & 13 & Open & Public \\
\midrule
\multicolumn{5}{l}{\textbf{LOC Subtotal}} & \textbf{2,984} & \textbf{2,765} & \textbf{2,211} & \textbf{554} & & \\
\midrule
\multicolumn{10}{l}{\textit{Function Point (FP) datasets}} \\
\quad Albrecht (1979) & 1979 & \texttt{10.1147/sj.183.0171} & FP & 26 & 24 & 19 & 5 & Open & Public \\
\quad Desharnais\textsuperscript{*} & 1989 & \texttt{github.com/Derek-Jones/Software-estimation-datasets} & FP & 81 & 77 & 62 & 15 & CC0 & Public \\
\quad Kemerer & 1987 & \texttt{10.1145/38807.38814} & FP & 15 & 15 & 12 & 3 & Open & Public \\
\quad ISBSG (subset) & 2005 & Commercial (public subset) & FP & 45 & 42 & 34 & 8 & Restricted & Subset \\
\midrule
\multicolumn{5}{l}{\textbf{FP Subtotal}} & \textbf{167} & \textbf{158} & \textbf{127} & \textbf{31} & & \\
\midrule
\multicolumn{10}{l}{\textit{Use Case Point (UCP) datasets}} \\
\quad Silhavy et al.\textsuperscript{*} & 2017 & \texttt{10.1016/j.infsof.2016.12.001} \& \texttt{Derek-Jones repo} & UCP & 74 & 71 & 57 & 14 & CC0 & Public \\
\quad Huynh et al.\textsuperscript{\ddag} & 2023 & \texttt{10.1109/ACCESS.2023.3286372} \& \texttt{zenodo.org/7022735} & UCP & 53 & 48 & 38 & 10 & CC-BY & Public \\
\quad Karner (original) & 1993 & Technical report (reconstructed) & UCP & 12 & 12 & 10 & 2 & N/A & Reconstructed \\
\midrule
\multicolumn{5}{l}{\textbf{UCP Subtotal}} & \textbf{139} & \textbf{131} & \textbf{105} & \textbf{26} & & \\
\midrule
\multicolumn{5}{l}{\textbf{Grand Total (All Schemas)}} & \textbf{3,290} & \textbf{3,054} & \textbf{2,443} & \textbf{611} & & \\
\bottomrule
\multicolumn{10}{l}{\footnotesize \textit{Note:} License = data usage terms; Access = Public (freely available), Subset (limited release), Reconstructed (from published paper).} \\
\multicolumn{10}{l}{\footnotesize \textsuperscript{\dag}DASE = Data Analysis in Software Engineering repository (Rodríguez et al., aggregated datasets 1979--2022).} \\
\multicolumn{10}{l}{\footnotesize \textsuperscript{*}Derek-Jones = Curated public software estimation datasets repository (github.com/Derek-Jones/Software-estimation-datasets).} \\
...
\multicolumn{10}{l}{\footnotesize Rebuild scripts (commit \texttt{a7f3c2d}), harmonization code, and MD5 hashes archived at DOI: 10.5281/zenodo.XXXXXX (anonymous link during review).} \\
\multicolumn{10}{l}{\footnotesize Public release planned upon acceptance at \texttt{github.com/[author-repo]/effort-estimation-reproducibility} with full replication package.} \\
\end{tabular}
\end{table*}

\paragraph{Data sources and provenance.}
For each dataset, we retained: (i) original source name, (ii) publication year, (iii) DOI or GitHub URL, (iv) schema type (LOC/FP/UCP), (v) raw record counts, and (vi) post-deduplication counts. This manifest enables full audit trails and future replication studies. 
...
(\textit{LOC}, \textit{FP}, and \textit{UCP}) using macro-averaging to avoid LOC dominance. 
All metrics include bootstrap 95\% confidence intervals to quantify prediction uncertainty.
...
Key findings:
\begin{itemize}[leftmargin=1.5em]
    \item RF achieved \textbf{42\% lower MMRE} than the Calibrated Baseline (0.647 vs. 1.12), 
    with tight confidence intervals indicating stable performance.
...
\paragraph{FP Schema.}
The Function Point (FP) schema exhibited higher variability due to its small sample size ($n=24$) 
...
especially for small-sample schemas (e.g., FP, $n{=}24$).  
