...
\textbf{GitHub Repository:} All code, data, and reproducibility artifacts are publicly available at \href{https://github.com/Huy-VNNIC/AI-Project}{github.com/Huy-VNNIC/AI-Project} (MIT~License)
...
\textit{Verification:} Successfully rebuilt results on Ubuntu~22.04, Python~3.9.12, numpy~1.24.3 (deterministic with \texttt{random\_seed=42}). &
