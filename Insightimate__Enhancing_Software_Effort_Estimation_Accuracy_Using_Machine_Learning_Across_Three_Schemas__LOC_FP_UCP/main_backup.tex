...
\uppercase{P.~W.~C.~Prasad}\authorrefmark{1}, and \uppercase{Md Shohel Sayeed}\authorrefmark{2},
\IEEEmembership{Member, IEEE}}

\address[1]{International School, Duy Tan University, Da Nang 550000, Vietnam
(e-mail: nhathuycntt@gmail.com)}
...
\markboth
{Huy et al.: Insightimate: Software Effort Estimation Using Machine Learning}
{Huy et al.: Insightimate: Software Effort Estimation Using Machine Learning}
...
an anonymous GitHub repository during review and will be permanently archived with a Zenodo DOI upon acceptance.
